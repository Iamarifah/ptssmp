...
<body>
    ...
    <section class="hero-section">
        ...
        <img src="img/poli.png" alt="" width="500" height="600">
    ...
    <section class="women-banner spad">
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-3">
                    <div class="product-large set-bg" data-setbg="img/products/sport.jpg">
            ...
            <div class="row">
                <div class="col-lg-8">
                    ...
                    <div class="product-slider owl-carousel">
                        <div class="product-item">
                            <div class="pi-pic">
                                <img src="img/products/ramen.jpg" alt="">
                                <div class="sale">Sale</div>
                                <div class="icon">
                                    <i class="icon_heart_alt"></i>
                                </div>
                        ...
                        <div class="product-item">
                            <div class="pi-pic">
                                <img src="img/products/milk.png" alt="">
                                <div class="icon">
                                    <i class="icon_heart_alt"></i>
                                </div>
                                <ul>
                        ...
                        <div class="product-item">
                            <div class="pi-pic">
                                <img src="img/products/lotus1.jpg" alt="">
                                <div class="icon">
                                    <i class="icon_heart_alt"></i>
                                </div>
                                <ul>
                ...
                <div class="col-lg-3 offset-lg-1">
                    <div class="product-large set-bg m-large" data-setbg="img/products/shoes.jpg">
                        <h2>Accessories/
                            Shoes</h2>
                        <a href="#">Discover More</a>
                    </div>
