                    ...
                    <div class="product-list">
                        <div class="row">
                            ...
                            <div class="col-lg-4 col-sm-6">
                                <div class="product-item">
                                    <div class="pi-pic">
                                        <img src="img/products/bag.jpg" alt="">
                                        <div class="icon">
                                            <i class="icon_heart_alt"></i>
                                        </div>
                                        <ul>
                            ...
                            <div class="col-lg-4 col-sm-6">
                                <div class="product-item">
                                    ...
                                    <div class="pi-text">
                                        <div class="catagory-name">Watches</div>
                                        <a href="#">
                                            <h5>Stainless Steel Watches</h5>
                                        </a>
                                        <div class="product-price">
                                            RM 30.00
                                            <span></span>
                            ...
                            <div class="col-lg-4 col-sm-6">
                                <div class="product-item">
                                    <div class="pi-pic">
                                        <img src="img/products/beannie.jpg" alt="">
                                        <div class="icon">
                                            <i class="icon_heart_alt"></i>
                                        </div>
                                        <ul>
                                    ...
                                    <div class="pi-text">
                                        <div class="catagory-name">Hats</div>
                                        <a href="#">
                                            <h5>Plain Beanie</h5>
                                        </a>
                                        <div class="product-price">
                            ...
                            <div class="col-lg-4 col-sm-6">
                                <div class="product-item">
                                    ...
                                    <div class="pi-text">
                                        <div class="catagory-name">Bag</div>
                                        <a href="#">
                                            <h5>Casual Plaid Linen Cotton Tote Bag</h5>
                                        </a>
                                        <div class="product-price">
                                            RM 6.50
                                            <span></span>
                            ...
                            <div class="col-lg-4 col-sm-6">
                                <div class="product-item">
                                    ...
                                    <div class="pi-text">
                                        <div class="catagory-name">Shoes</div>
                                        <a href="#">
                                            <h5> Fashion Comfortable Sports Shoes</h5>
                                        </a>
                                        <div class="product-price">
                                            RM 16.90
                                            <span></span>
