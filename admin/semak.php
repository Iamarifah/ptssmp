...
if ($uname == 'admin') {
    ...
    if ($pass == $row->pass) {
        ...
        ?>
        <script>
            alert ('Username and Password Incorrect!!!! 1');
    ...
    if ($result->num_rows == 1) {
        ...
        if ($pass == $row->pass) {
            header('location: studentstaff/');
        } else {
            ?>
            <script>
                alert ('Username and Password Incorrect!!!! 2');
                window.location='login.php';
            </script>
            <?php
        }
        ...
        if ($result->num_rows == 1) {
            ...
            if ($pass == $row->pass) {
                ...
                ?>
                <script>
                    alert ('Username and Password Incorrect!!!! 3');
                    window.location='login.php';
                </script>
                <?php
            }
            ...
            ?>
            <script>
                alert ('Username and Password Incorrect!!!! 4');
                window.location='login.php';
            </script>
            <?php
        }
